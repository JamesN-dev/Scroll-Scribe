...
Using a `Context` as a stack comes in handy in [some custom template tags](https://docs.djangoproject.com/en/5.2/howto/custom-template-tags/#howto-writing-custom-template-tags).
