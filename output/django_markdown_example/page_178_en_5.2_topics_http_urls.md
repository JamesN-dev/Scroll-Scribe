...
Another possibility is to include additional URL patterns by using a list of [`path()`](../../../ref/urls/#django.urls.path) instances. For example, consider this URLconf:
