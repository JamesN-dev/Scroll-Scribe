...
This example uses Django’s [template system](https://docs.djangoproject.com/en/5.2/topics/templates/), which has several powerful features but strives to stay simple enough for non-programmers to use.
